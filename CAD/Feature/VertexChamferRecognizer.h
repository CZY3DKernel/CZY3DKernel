...
class VertexChamferRecognizer
{
   public:
    // 构造函数
    VertexChamferRecognizer(std::shared_ptr<AttributeAdjacentGraph> aag,
                            const TopoDS_Face& face);

    /*
     * @brief recognize if face is Vertex single chamfer;
     * @param[out] feature
     * @return true if face is vertex single chamfer and set feature; false otherwise
     */
    bool IsVertexSingleChamfer(ChamferFeature& feature);

    /*
     * @brief recognize if face is vertex joint chamfer;
     * @param[out] feature
     * @return true if face is vertex joint chamfer and set feature; false otherwise
     */
    bool IsVertexJointChamfer(ChamferFeature& feature) const;
