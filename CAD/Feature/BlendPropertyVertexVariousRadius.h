...
EXTENSION_EXPORT class BlendPropertyVertexVariousRadius : public BlendProperty
{
   public:
        BlendPropertyVertexVariousRadius(int faceId, double minRadius, double maxRadius,
                                     double avgRadius,
